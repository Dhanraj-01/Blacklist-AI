...
window.handleFinalDDG = function(data) {
    if (currentTypingWrapper) currentTypingWrapper.remove();
    let answer = data && data.AbstractText ? data.AbstractText : "I searched everywhere but couldn't find a direct answer. Try asking something else! ✨";
...
window.handleDDGResponse = function(data) {
    ...
    // 3. अगर कुछ भी न मिले तो साफ शब्दों में बताना
        ...
        appendMessage( "Sorry, I am in testing mode I answer only few questions.", 'ai-message');
    }
};
